...
header = ["retired", "Other size file name", "Other side file name", "Handwriting file name", "# Parent unique identifier", "#Parent unique identifier", "#Handwriting unique identifier", "T5", "T6", "T7"]
